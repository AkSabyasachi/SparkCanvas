    ...
    <div className="flex flex-wrap items-start h-full p-6 gap-4 overflow-y-scroll text-slate-700">
      ...
      >
        <div className="flex items-center gap-3">
          <Sparkles className="w-6 text-[#8e18ac]" />
        ...
        <button
          disabled={loading}
          className="w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#bc1ee3] to-[#8e37eb] text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer "
        >
          {loading ? (
      ...
      <div className="w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96">
        <div className="flex items-center gap-3">
          <Hash className="w-5 h-5 text-[#bc29da]" />
        ...
        {!content ? (
          ...
          <div className="mt-3 h-full text-sm overflow-y-scroll text-slate-600">
