        ...
        <div className='px-4 sm:px-20 xl:px-32 py-24'>
            ...
            <div className='flex flex-wrap mt-10 justify-center'>
                {dummyTestimonialData.map((testimonial, index) => (
                    <div key={index} className='p-8 m-4 max-w-xs rounded-lg bg-[#FDFDFE] shadow-xl border border-gray-100 hover:-translate-y-1 hover:shadow-2xl transition duration-300 cursor-pointer'>
